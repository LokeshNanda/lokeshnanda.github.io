...
Every post on this blog is a markdown file in a git repository. Publishing works like any other pipeline I build:
...
This is the first post. The older writing from Medium and my weekly-learnings site is being consolidated here, so everything lives in one place I control.
